...
const footerLinks = [
  ...
  { label: "Our Workshops", href: "#classes" },
    ...
    <footer className="bg-dark-bg pt-16 pb-8">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-12 md:grid-cols-3">
          {/* Brand */}
          <div>
            <h3 className="mb-2 font-serif text-2xl font-bold tracking-[0.2em] text-white uppercase">
              Taste Buds
            </h3>
            <p className="mb-1 text-xs tracking-[0.4em] text-gold uppercase">
              Cooking School
            </p>
            <p className="mt-4 text-sm leading-relaxed text-white/40">
              Premium cooking workshops and classes for every skill level. Learn
        ...
        <div className="mt-12 border-t border-white/10 pt-6 text-center text-xs text-white/30">
          © {new Date().getFullYear()} Taste Buds. All rights reserved.
        </div>
      </div>
    </footer>
  );
